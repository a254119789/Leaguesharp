namespace NechritoRiven.Menus
{
    ...
    internal class MenuConfig : Core
    {
        ...
        public static void LoadMenu()
        {
            ...
            animation.AddItem(new MenuItem("QD", "Q1 Delay").SetValue(new Slider(200, 200, 350)));
            animation.AddItem(new MenuItem("Q2D", "Q2 Delay").SetValue(new Slider(200, 200, 350)));
            animation.AddItem(new MenuItem("Q3D", "Q3 Delay").SetValue(new Slider(250, 250, 350)));
