namespace ReformedAIO.Champions.Annie.TibbersAI
{
    ...
    internal sealed class TibbersAI : OrbwalkingChild
    {
        ...
        private Obj_AI_Hero Target => TargetSelector.GetTarget(1000, TargetSelector.DamageType.Magical);
        ...
        private void OnUpdate(EventArgs args)
        {
            ...
            {
                ObjectManager.Player.IssueOrder(tibbers.Distance(Target) > tibbers.AttackRange
            ...
            {
                ObjectManager.Player.IssueOrder(tibbers.Distance(gameObjectStructure) > tibbers.AttackRange
                ? GameObjectOrder.MovePet
                : GameObjectOrder.AttackUnit,
                gameObjectStructure);
            }
            ...
            {
                ObjectManager.Player.IssueOrder(tibbers.Distance(Minion) > tibbers.AttackRange
              ? GameObjectOrder.MovePet
              : GameObjectOrder.AttackUnit,
                Minion);
            }
